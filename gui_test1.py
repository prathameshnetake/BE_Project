...
"color: rgb(255, 255, 255);"))
        ...
        self.available.setGeometry(QtCore.QRect(90, 330, 491, 61))
        self.available.setStyleSheet(_fromUtf8("font: 18pt \"Rockwell\";\n"
"color: rgb(255, 255, 255);"))
        self.available.setObjectName(_fromUtf8("available"))
        self.input = QtGui.QTextEdit(self.frame_3)
        self.input.setGeometry(QtCore.QRect(90, 400, 111, 41))
        self.input.setStyleSheet(_fromUtf8("background-color: rgb(255, 255, 255);"))
        self.input.setObjectName(_fromUtf8("input"))
        self.warning = QtGui.QLabel(self.frame_3)
        self.warning.setGeometry(QtCore.QRect(90, 460, 491, 61))
...
"color: rgb(255, 255, 255);"))
        ...
        self.last.setGeometry(QtCore.QRect(90, 540, 491, 61))
...
"color: rgb(255, 255, 255);"))
    ...
    def retranslateUi(self, Form):
        ...
        self.warning.setText(_translate("Form", "Oops! That letter is not in my word:", None))
        self.last.setText(_translate("Form", "Sorry, you ran out of guesses. The word was :", None))
